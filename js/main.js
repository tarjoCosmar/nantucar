...
const autosNuevos = [
    ...
    { id: 2,  img: 'img/jac-hfc-dc2ton.jpg',     titulo: 'JAC HFC Doble Cabina 2 Ton',precio: 0, descripcion: 'Nuevo | Camión | 2 Toneladas | Doble Cabina',   specs: ['Carga máx: 2 Ton', 'Cabina: Doble'],          tipo: 'nuevo', marca: 'jac',    modelo: 'camion',    categoria: 'Camiones JAC' },
    { id: 39, img: 'img/autos/Camion%20JAC%201035%20DOBLE%20CABINA/Camion%20JAC%201035%20DOBLE%20CABINA%20FRENTE.jpeg', titulo: 'JAC HFC 1035 Doble Cabina', precio: 0, descripcion: 'Nuevo | Camión | Doble Cabina | 0 km', specs: ['Cabina: Doble', 'Carga máx: 1.5 Ton'], tipo: 'nuevo', marca: 'jac', modelo: 'camion', categoria: 'Camiones JAC' },
    ...
    { id: 4,  img: 'img/jac-hfc1060-55.jpg',     titulo: 'JAC HFC 1060',              precio: 0, descripcion: 'Nuevo | Camión | 5.5 Toneladas | 0 km',        specs: ['Carga máx: 5.5 Ton'],                         tipo: 'nuevo', marca: 'jac',    modelo: 'camion',    categoria: 'Camiones JAC' },
    { id: 5,  img: 'img/jac-hfc1063kn.jpg',      titulo: 'JAC HFC 1063 KN',           precio: 0, descripcion: 'Nuevo | Camión | 6 Toneladas | 0 km',          specs: ['Carga máx: 6 Ton'],                           tipo: 'nuevo', marca: 'jac',    modelo: 'camion',    categoria: 'Camiones JAC' },
    { id: 6,  img: 'img/jac-hfc1120.jpg',        titulo: 'JAC HFC 1120',              precio: 0, descripcion: 'Nuevo | Camión | 8 Toneladas | 0 km',          specs: ['Carga máx: 8 Ton'],                           tipo: 'nuevo', marca: 'jac',    modelo: 'camion',    categoria: 'Camiones JAC' },
    { id: 7,  img: 'img/autos/CAMION%20JAC%201040/CAMION_JAC-1040-FRENTE.jpeg', titulo: 'JAC HFC 1040',              precio: 0, descripcion: 'Nuevo | Camión | 11 Toneladas | 0 km',         specs: ['Carga máx: 11 Ton'],                          tipo: 'nuevo', marca: 'jac',    modelo: 'camion',    categoria: 'Camiones JAC' },
    { id: 8,  img: 'img/jac-hfc1060-13.jpg',     titulo: 'JAC HFC 1060',              precio: 0, descripcion: 'Nuevo | Camión | 13 Toneladas | 0 km',         specs: ['Carga máx: 13 Ton'],                          tipo: 'nuevo', marca: 'jac',    modelo: 'camion',    categoria: 'Camiones JAC' },
    { id: 9,  img: 'img/jac-hfc1180.jpg',        titulo: 'JAC HFC 1180 320 HP',       precio: 0, descripcion: 'Nuevo | Camión | 13 Toneladas | 320 HP',       specs: ['Carga máx: 13 Ton', 'Potencia: 320 HP'],      tipo: 'nuevo', marca: 'jac',    modelo: 'camion',    categoria: 'Camiones JAC' },
    ...
    { id: 11, img: 'img/jac-hfc1252.jpg',        titulo: 'JAC HFC 1252',              precio: 0, descripcion: 'Nuevo | Camión | 18.5 Toneladas | 0 km',       specs: ['Carga máx: 18.5 Ton'],                        tipo: 'nuevo', marca: 'jac',    modelo: 'camion',    categoria: 'Camiones JAC' },
    { id: 12, img: 'img/jac-hfc4181.jpg',        titulo: 'JAC HFC 4181',              precio: 0, descripcion: 'Nuevo | Tractocamión | 28 Toneladas | 0 km',   specs: ['Carga máx: 28 Ton', 'Tipo: Tractocamión'],    tipo: 'nuevo', marca: 'jac',    modelo: 'camion',    categoria: 'Camiones JAC' },
    ...
    { id: 18, img: 'img/jac-hfc4254-volqueta.jpg',titulo: 'JAC HFC 4254 Volqueta',   precio: 0, descripcion: 'Nuevo | Volqueta | 48 Toneladas | 0 km',        specs: ['Tipo: Volqueta', 'Carga máx: 48 Ton'],        tipo: 'nuevo', marca: 'jac',    modelo: 'camion',    categoria: 'Camiones JAC' },

    // ─── CAMIONETAS (6) ──────────────────────────────────────────────
    { id: 19, img: 'img/jac-t6-gasolina.jpg',    titulo: 'JAC T6 Gasolina',           precio: 0, descripcion: 'Nuevo | Camioneta 4x4 | Gasolina | 0 km',      specs: ['Combustible: Gasolina', 'Tracción: 4x4'],     tipo: 'nuevo', marca: 'jac',    modelo: 'camioneta', categoria: 'Camionetas' },
    { id: 20, img: 'img/jac-t6-diesel.jpg',      titulo: 'JAC T6 Diésel',             precio: 0, descripcion: 'Nuevo | Camioneta 4x4 | Diésel | 0 km',        specs: ['Combustible: Diésel', 'Tracción: 4x4'],       tipo: 'nuevo', marca: 'jac',    modelo: 'camioneta', categoria: 'Camionetas' },
    { id: 21, img: 'img/jac-t8.jpg',             titulo: 'JAC T8',                    precio: 0, descripcion: 'Nuevo | Camioneta | Gasolina | 0 km',          specs: ['Combustible: Gasolina'],                      tipo: 'nuevo', marca: 'jac',    modelo: 'camioneta', categoria: 'Camionetas' },
    { id: 22, img: 'img/jac-t8-pro.jpg',         titulo: 'JAC T8 Pro',                precio: 0, descripcion: 'Nuevo | Camioneta Premium | Gasolina | 0 km',  specs: ['Versión: Pro', 'Combustible: Gasolina'],      tipo: 'nuevo', marca: 'jac',    modelo: 'camioneta', categoria: 'Camionetas' },
    { id: 23, img: 'img/jac-t9.jpg',             titulo: 'JAC T9',                    precio: 0, descripcion: 'Nuevo | Camioneta Full Size | Gasolina | 0 km',specs: ['Combustible: Gasolina'],                      tipo: 'nuevo', marca: 'jac',    modelo: 'camioneta', categoria: 'Camionetas' },
    ...
    { id: 27, img: 'img/jetour-x70-plus.jpg',    titulo: 'JETOUR X70 Plus',           precio: 0, descripcion: 'Nuevo | SUV | Versión Plus | 0 km',            specs: ['Versión: Plus'],                              tipo: 'nuevo', marca: 'jetour', modelo: 'suv',       categoria: 'Jetour' },
    ...
    // ─── KARRY (2) ───────────────────────────────────────────────────
    { id: 36, img: 'img/karry-minivan.jpg',      titulo: 'KARRY Mini Van',            precio: 0, descripcion: 'Nuevo | Mini Van | 11 Pasajeros | 0 km',       specs: ['Pasajeros: 11', 'Tipo: Mini Van'],            tipo: 'nuevo', marca: 'karry',  modelo: 'minivan',   categoria: 'Karry' },
    { id: 37, img: 'img/karry-pickup.jpg',       titulo: 'KARRY Pick Up CS/CD',       precio: 0, descripcion: 'Nuevo | Camioneta | CS / CD | 0 km',           specs: ['Cabina: Simple y Doble disponibles'],         tipo: 'nuevo', marca: 'karry',  modelo: 'camioneta', categoria: 'Karry' }
];
...
const galeriaAutos = {
    ...
    7:  ['img/autos/CAMION%20JAC%201040/CAMION_JAC-1040-LATERAL.jpeg','img/autos/CAMION%20JAC%201040/CAMION_JAC-1040-INTERIOR.jpeg','img/autos/CAMION%20JAC%201040/CAMION_JAC-1040-POSTERIOR.jpeg','img/autos/CAMION%20JAC%201040/CAMION_JAC-1040-TABLERO.jpeg'],
    ...
    39: ['img/autos/Camion%20JAC%201035%20DOBLE%20CABINA/Camion%20JAC%201035%20DOBLE%20CABINA%20LATERAL.jpeg','img/autos/Camion%20JAC%201035%20DOBLE%20CABINA/Camion%20JAC%201035%20DOBLE%20CABINA%20POSTERIOR.jpeg','img/autos/Camion%20JAC%201035%20DOBLE%20CABINA/Camion%20JAC%201035%20DOBLE%20CABINA%20CABINA%201.jpeg','img/autos/Camion%20JAC%201035%20DOBLE%20CABINA/Camion%20JAC%201035%20DOBLE%20CABINA%20CABINA%202.jpeg','img/autos/Camion%20JAC%201035%20DOBLE%20CABINA/Camion%20JAC%201035%20DOBLE%20CABINA%20TABLERO.jpeg']
};
